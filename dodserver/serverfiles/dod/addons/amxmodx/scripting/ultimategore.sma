#define PLUGIN "Ultimate Gore"
#define VERSION "1.0.0"
#define AUTHOR "Jonathan Linat"

/* AMX Mod X script.
*
*   Ultimate Gore Enhancement (amx_ultimategore_ultimate.sma)
...
*   with the cvar "amx_ultimategore" using these flags:
*
*   a - Headshot blood
*   b - Extra blood effects
*   c - Bleeding on low health
*   d - Gib explosion (Explosives and damage over "amx_ultimategore_exphp")
*   e - Extra Gory Mode
*   f - Extra Headshot Gore Only (same as with flag "e")
*   g - Hostage Gore (CS/CZ Only)
*
*   Default is: amx_ultimategore "abcde"
*
*   New CVAR: amx_ultimategore_exphp (default 160)
...
*
*   v1.6.1 - Rafael "R4to0" Maciel - September 20, 2017
...
public plugin_init()
{
  register_plugin(PLUGIN, VERSION, AUTHOR);
	...
	pcvar_gore = register_cvar("amx_ultimategore","abcde")
	pcvar_gore_exphp = register_cvar("amx_ultimategore_exphp","160")
