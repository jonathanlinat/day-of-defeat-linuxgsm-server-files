...
public plugin_init()
{
    ...
    register_clcmd("amx_hitmarx_demo","@demo",ADMIN_KICK,"|Hitmarker Demo");
    register_clcmd("amx_hitmarx_demo_end","@demo_end",ADMIN_KICK,"|End Hitmarker Demo");
    ...
    pRainbow    = register_cvar("amx_hitmarx_rainbow", "1"); // Enables/disables random colors on every hit.
    bind_pcvar_num(register_cvar("amx_hitmarx_random", "1"), pSpinners); //Enables/disables random hit markers.
    pMarkerRed  = register_cvar("amx_hitmarx_rcolor", "165"); // RGB - Red (This won't work when amx_hitmarx_rainbow = 1)
    pMarkerGRN  = register_cvar("amx_hitmarx_gcolor", "165"); // RGB - GRN (This won't work when amx_hitmarx_rainbow = 1)
    pMarkerBLU  = register_cvar("amx_hitmarx_bcolor", "165"); // RGB - BLU (This won't work when amx_hitmarx_rainbow = 1)
    pHUDx       = register_cvar("amx_hitmarx_xpos", "-1.0"); // x pos
    pHUDy       = register_cvar("amx_hitmarx_ypos", "-1.0"); // y pos
    pLinger     = register_cvar("amx_hitmarx_holdtime", "0.5"); // hud hold time
