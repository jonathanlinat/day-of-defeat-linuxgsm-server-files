...
public plugin_init() {
    ...
    pAutoDeploy = register_cvar("amx_parachute_autorip", "200");
    pParaModel = register_cvar("amx_parachute_model", "1");
}

public plugin_precache() {
    g_model = precache_model("models/amx_parachute.mdl");
}
